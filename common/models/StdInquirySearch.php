...
class StdInquirySearch extends StdInquiry
{
    ...
    {
        return [
            [['std_inquiry_id', 'branch_id', 'std_obtained_marks', 'std_total_marks', 'created_by', 'updated_by'], 'integer'],
            [['std_inquiry_no', 'inquiry_session', 'std_name', 'std_father_name', 'gender', 'std_contact_no', 'std_father_contact_no', 'std_inquiry_date', 'std_intrested_class', 'std_previous_class', 'previous_institute', 'std_roll_no', 'std_percentage', 'refrence_name', 'refrence_contact_no', 'refrence_designation', 'std_address', 'comment', 'inquiry_status', 'created_at', 'updated_at'], 'safe'],
        ];
    }
     ...
     public function search($params)
    {
        if(Yii::$app->user->identity->user_type == 'Superadmin'){
            ...
            $query->andFilterWhere(['like', 'std_inquiry_no', $this->std_inquiry_no])
                ...
                ->andFilterWhere(['like', 'previous_institute', $this->previous_institute])
