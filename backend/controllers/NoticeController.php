...
class NoticeController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                try {
                    ...
                    $transaction->commit();
                    Yii::$app->session->setFlash('warning', "You have successfully add notice...!");
                } catch (Exception $e) {
                ...
                return [
                    ...
                    'title'=> "Create new Notice",
                    'content'=>'<span class="text-success">Create Notice success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            ...
            if($request->isGet){
                ...
                try {
                    ...
                    $transaction->commit();
                    Yii::$app->session->setFlash('warning', "You have successfully update notice...!");
                } catch (Exception $e) {
                    $transaction->rollBack();
                    Yii::$app->session->setFlash('error', "Transaction Failed, Try Again...!");
                }
    ...
    /**
     * Delete an existing Notice model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Notice model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
