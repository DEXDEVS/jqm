...
class EventsCalendarController extends Controller
{
    ...
    {    
        $events = EventsCalendar::find()->all();

        $tasks = [];
        foreach ($events as $eve) {
            $event = new \yii2fullcalendar\models\Event();
            $event->id = $eve->calendar_id;
            $event->title = $eve->title;
            $event->start = $eve->date;
            $tasks[] = $event;
        }
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new EventsCalendar",
                ...
                return [
                    ...
                    'title'=> "Create new EventsCalendar",
                    'content'=>'<span class="text-success">Create EventsCalendar success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update EventsCalendar #".$id,
    ...
    /**
     * Delete an existing EventsCalendar model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing EventsCalendar model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
